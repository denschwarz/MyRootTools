...
signal1.SetBinContent(1, 2)
signal1.SetBinContent(2, 4)
signal1.SetBinContent(3, 10)
signal1.SetBinContent(4, 5)
signal1.SetBinContent(5, 2)
signal1.Add(hist1)
signal1.Add(hist2)

signal2 = ROOT.TH1F("signal2", "signal2", 5, 0, 500)
signal2.SetBinContent(1, 1)
signal2.SetBinContent(2, 2)
signal2.SetBinContent(3, 8)
signal2.SetBinContent(4, 20)
signal2.SetBinContent(5, 15)
signal2.Add(hist1)
signal2.Add(hist2)
